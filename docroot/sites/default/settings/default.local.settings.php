...
// Config split env status.
$config['config_split.config_split.local']['status'] = 1;
//$config['config_split.config_split.dev']['status'] = 0;
//$config['config_split.config_split.stage']['status'] = 0;
//$config['config_split.config_split.prod']['status'] = 0;

// Gin theme overrides.
// Override dark mode settings.
$config['gin.settings']['enable_darkmode'] = 1;

...
$additionalSettingsFiles = [
  DRUPAL_ROOT . "/sites/{$site_directory}/settings/stage_file_proxy.settings.php",
  DRUPAL_ROOT . "/sites/{$site_directory}/settings/file_system.settings.php",
  DRUPAL_ROOT . "/sites/{$site_directory}/settings/environments.settings.php",
  DRUPAL_ROOT . "/sites/{$site_directory}/settings/recaptcha.settings.php",
  DRUPAL_ROOT . "/sites/{$site_directory}/settings/language.negotiation.settings.php"
];
